    ...
    async def _build_code_valid_result(
        ...
        *,
        ...
        return AgentResult(
            ...
            compile_output_text=report.output_text if report else None,
            compile_artifact_format=report.artifact_format if report else "urdf",
            compile_artifact_filename=report.artifact_filename if report else "model.urdf",
            compile_sidecar_json=report.sidecar_json if report else None,
